---
name: Direction audio de jeu
description: Définit une identité musicale cohérente, les boucles, le mixage et les prompts audio. À utiliser pour composer, générer ou intégrer la musique d’un jeu.
---

# Direction audio de jeu
