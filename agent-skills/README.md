...
## Blockchain / Solana - Protocol skills (solana-protocols/)

46 skills de protocoles Solana (source : packs Helius / Light Protocol / Pyth / Solana Kit / Surfpool / VulnHunter, dédupliqués). Installés dans `skills/solana-protocols/<protocol>/`.
...
| [light-protocol](skills/solana-protocols/light-protocol/SKILL.md) | ZK compression, rent-free state | Compressed accounts |
| [solana-kit](skills/solana-protocols/solana-kit/SKILL.md) | @solana/kit (web3.js v3) migration et usage | Nouveau code client Solana |
| [surfpool](skills/solana-protocols/surfpool/SKILL.md) | Surfpool : mainnet-fork devnet local | Tests contre état mainnet |
| [vulnhunter](skills/solana-protocols/vulnhunter/SKILL.md) | Audit sécurité programmes Solana | Review sécurité avant deploy |
| [arcium](skills/solana-protocols/arcium/SKILL.md) | Calcul chiffré on-chain | Confidentialité programmable |
| [birdeye](skills/solana-protocols/birdeye/SKILL.md) | Birdeye API : market data, trading | Données de marché |
| [squads](skills/solana-protocols/squads/SKILL.md) | Squads multisig / MPC | Gouvernance de trésorerie |
| [kamino](skills/solana-protocols/kamino/SKILL.md) | Kamino lending / vaults | Lending on-chain |
| [marginfi](skills/solana-protocols/marginfi/SKILL.md) | MarginFi lending | Protocoles de marge |
| [meteora](skills/solana-protocols/meteora/SKILL.md) | Meteora DLMM / vaults | Liquidité dynamique |
| [orca](skills/solana-protocols/orca/SKILL.md) | Orca Whirlpools | AMM concentré |
| [raydium](skills/solana-protocols/raydium/SKILL.md) | Raydium AMM v4 / CPMM | Swaps et pools |
| [pumpfun](skills/solana-protocols/pumpfun/SKILL.md) | Pump.fun launchpad | Lancement de tokens |
| [debridge](skills/solana-protocols/debridge/SKILL.md) | deBridge cross-chain | Bridges |
| [lifi](skills/solana-protocols/lifi/SKILL.md) | LI.FI cross-chain routing | Aggregation bridge |
| [magicblock](skills/solana-protocols/magicblock/SKILL.md) | MagicBlock ERN, rollups ephemeral | Jeux on-chain temps réel |
| [switchboard](skills/solana-protocols/switchboard/SKILL.md) | Switchboard oracles / VRF | Randomness on-chain |
| [wallet-analysis](skills/solana-protocols/wallet-analysis/SKILL.md) | Analyse de wallets, clusters, flows | Investigation on-chain |
| [sanctum](skills/solana-protocols/sanctum/SKILL.md) | Sanctum LST / stake pools | Liquid staking |
| [phoenix](skills/solana-protocols/phoenix/SKILL.md) | Phoenix DEX orderbook | Spot orderbook on-chain |
| [manifest](skills/solana-protocols/manifest/SKILL.md) | Manifest DEX | Trading spot |
| [phantom-connect](skills/solana-protocols/phantom-connect/SKILL.md) | Phantom wallet connection | Connexion wallet |
| [phantom-wallet-mcp](skills/solana-protocols/phantom-wallet-mcp/SKILL.md) | Phantom via MCP | Agents avec wallet |
| [dflow](skills/solana-protocols/dflow/SKILL.md) | DFlow order flow | Payment flow trading |
| [lulo](skills/solana-protocols/lulo/SKILL.md) | Lulo (Flexlend) | Yield lending |
| [lavarage](skills/solana-protocols/lavarage/SKILL.md) | Lavarage leveraged trading | Trading à levier |
| [ranger-finance](skills/solana-protocols/ranger-finance/SKILL.md) | Ranger Finance | Perp protocols |
| [carbium](skills/solana-protocols/carbium/SKILL.md) | Carbium | Trading |
| [coingecko](skills/solana-protocols/coingecko/SKILL.md) | CoinGecko API | Prix et market data |
| [ct-alpha](skills/solana-protocols/ct-alpha/SKILL.md) | CT Alpha | Signal trading |
| [glam](skills/solana-protocols/glam/SKILL.md) | GLAM | Gestion d'actifs on-chain |
| [helius-dflow](skills/solana-protocols/helius-dflow/SKILL.md) | Helius DFlow | Staking flow |
| [helius-phantom](skills/solana-protocols/helius-phantom/SKILL.md) | Helius Phantom | Intégration wallet/Helius |
| [inco](skills/solana-protocols/inco/SKILL.md) | Inco | Confidentialité |
| [metengine](skills/solana-protocols/metengine/SKILL.md) | MetEngine | Mint engines |
| [pinocchio-development](skills/solana-protocols/pinocchio-development/SKILL.md) | Pinocchio framework | Programmes Rust minimalistes |
| [sol-incinerator](skills/solana-protocols/sol-incinerator/SKILL.md) | Sol Incinerator | Burn de tokens/rent |
| [solana-agent-kit](skills/solana-protocols/solana-agent-kit/SKILL.md) | SendAI Solana Agent Kit | Agents IA on-chain |
| [solana-kit-migration](skills/solana-protocols/solana-kit-migration/SKILL.md) | Migration web3.js → @solana/kit | Upgrade client |
| [svm](skills/solana-protocols/svm/SKILL.md) | SVM (Solana Virtual Machine) | Rollups / forks SVM |
| [zz-code-recon](skills/solana-protocols/zz-code-recon/SKILL.md) | Code recon | Reconnaissance de code |

> Les 46 skills `solana-protocols/` utilisent le frontmatter `name:` original du protocole (ex. `jupiter`, `helius`). Dupliqués 6× dans les packs d'origine, présents une seule fois ici.

---

## Game Design - Game feel & direction artistique (game-design/)

7 skills (source : pack « Skill Game Dev »). Installés dans `skills/game-design/<skill>/`.

| Skill | What It Does | Use When |
|-------|-------------|----------|
| [seeker-strike-mobile](skills/game-design/seeker-strike-mobile/SKILL.md) | Conventions mobile/Solana Seeker Strike : Canvas 2D, wrapper WebView, économie SKR/GC | Mobile Solana game |
| [game-audio-direction](skills/game-design/game-audio-direction/SKILL.md) | Identité musicale, boucles, mixage, prompts audio | Bande-son de jeu |
| [motion-design-system](skills/game-design/motion-design-system/SKILL.md) | Motion UI performante, transitions, feedbacks | Transitions et juice |
| [pixel-art-audio-direction](skills/game-design/pixel-art-audio-direction/SKILL.md) | Direction pixel art + audio cohérente | Préproduction pixel art |
| [pixel-art-palette-discipline](skills/game-design/pixel-art-palette-discipline/SKILL.md) | Palette, grille, contraste, mise à l'échelle | Assets pixel art |
| [visual-design-premium](skills/game-design/visual-design-premium/SKILL.md) | Direction visuelle premium accessible | UI premium |
| [visual-rendering-game-feel](skills/game-design/visual-rendering-game-feel/SKILL.md) | Bloom, densité pixels, lumière, feedback d'impact | Rendu 2D et game feel |
...
| [mica-compliance-specialist](agents/specialized/mica-compliance-specialist.md) | MiCA Compliance Specialist | Conformité crypto UE : MiCA, RGPD, AML/KYC, risques réglementaires projets crypto-game |
| [tokenomics-designer](agents/game-development/tokenomics-designer.md) | Tokenomics Designer | Économies de jeu crypto : supply/demand, vesting, anti-inflation, rétention long terme |
