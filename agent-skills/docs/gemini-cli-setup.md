...
The repo ships 10 slash commands under `.gemini/commands/`: 8 lifecycle commands plus the `/webperf` and `/security-audit` specialist audits. Gemini CLI auto-discovers them when you run from the project root.
